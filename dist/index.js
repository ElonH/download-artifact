...
function downloadArtifactsWithRegExp(pattern, path) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (retry) {
            try {
                artifacts = yield downloadHttpClient.listArtifacts();
                break;
            }
            catch (e) {
        ...
        while (downloadQueue.length > 0) {
            ...
            if (timeDiff < 0)
                yield new Promise(resolve => setTimeout(resolve, timeDiff));
            try {
                ...
                downloadItem.retry--;
                if (downloadItem.retry == 0)
                    downloadFailureList.push(downloadItem.rsp);
                else {
                    downloadItem.nextTime = Date.now() + 60000;
                    core.warning(`Retry to download ${downloadItem.rsp.name} after 60 second`);
